...
const ReactQuill = dynamic(() => import("react-quill-new"), {
    ssr: false,
    loading: () => <div className="h-64 bg-[#111111] flex  rounded-xl border border-gray-200"></div>,
});
...
export default function RichTextEditor({ value, onChange, placeholder }: RichTextEditorProps) {
    ...
    return (
        <div className="rich-text-editor-wrapper bg-[#0A0A0A] rounded-xl border border-gray-200 overflow-hidden dark:bg-card-white dark:border-gray-800">
            <ReactQuill
                theme="snow"
                value={value}
                onChange={onChange}
