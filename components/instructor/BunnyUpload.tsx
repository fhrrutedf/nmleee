...
export default function BunnyUpload({ lessonId, onComplete }: BunnyUploadProps) {
    ...
    return (
        <div className="relative group transition-all w-full">
            <div className={`bg-[#0A0A0A] dark:bg-card-white border-2 border-dashed rounded-[32px] p-6 sm:p-8 text-center transition-all ${uploading ? 'border-emerald-600 bg-emerald-700 text-white/5 shadow-inner' : 'border-emerald-500/20 dark:border-gray-800 hover:border-emerald-600/50 hover:bg-[#111111]'}`}>
                {status === 'complete' ? (
                    <div className="space-y-4 py-4 animate-in fade-in zoom-in duration-300">
                        ...
                        <h3 className="text-xl font-bold text-[#10B981] dark:text-white">تم الرفع!</h3>
                    ...
                    <div className="space-y-4">
                        <div className={`w-16 h-16 bg-emerald-700 text-white/10 text-[#10B981] rounded-xl flex items-center justify-center mx-auto mb-2 transition-transform ${uploading ? ' scale-90' : 'group-hover:scale-110'}`}>
                        ...
                        {!uploading ? (
                            <div className="space-y-3">
                                ...
                                />
                                <div className="relative inline-block px-8 py-3 bg-emerald-700 text-white rounded-xl font-bold text-[10px] shadow-lg shadow-[#10B981]/20 shadow-accent/20 uppercase tracking-widest">
                            ...
                            <div className="max-w-xs mx-auto space-y-3">
                                <div className="h-2.5 bg-emerald-800 dark:bg-gray-800 rounded-xl overflow-hidden border border-white/5 shadow-inner">
                                    <div 
                                        className="h-full bg-emerald-700 text-white transition-all duration-300" 
