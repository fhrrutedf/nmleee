...
export const WhatsAppButton = () => {
    ...
    return (
        <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="fixed bottom-6 left-6 z-[60] w-12 h-12 bg-[#25D366] text-white rounded-xl flex items-center justify-center shadow-sm shadow-green-500/20 cursor-pointer border border-white/20"
