                    ...
                    {replyTo === comment.id && (
                        <div className="mt-3 flex gap-2">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="px-4 py-2 bg-ink text-white rounded-lg hover:bg-black transition-colors disabled:opacity-50"
                            >
                                <FiSend size={16} />
                            </button>
                        </div>
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex justify-end mt-2">
                            <button
                                ...
                                className="flex items-center gap-2 px-6 py-2 bg-ink text-white rounded-lg hover:bg-black transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                <FiSend size={16} />
                                نشر التعليق
                            </button>
