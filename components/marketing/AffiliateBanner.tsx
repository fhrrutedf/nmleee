    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white overflow-hidden relative z-50 transition-all border-b border-white/10"
            >
                <div className="max-w-7xl mx-auto px-4 py-2.5 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center animate-bounce shadow-lg shadow-white/10">
