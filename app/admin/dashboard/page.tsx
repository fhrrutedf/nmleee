            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <motion.div variants={itemVariants} className="relative group overflow-hidden bg-white dark:bg-card-white p-8 rounded-[2rem] shadow-lg shadow-emerald-600/20 border border-gray-100 dark:border-gray-800 hover:shadow-lg shadow-emerald-600/20 transition-all duration-500">
                        ...
                        <div className="flex justify-between items-start mb-6 relative z-10">
                            <div className="w-14 h-14 rounded-xl bg-gray-50 dark:bg-gray-800 text-emerald-600 flex items-center justify-center text-2xl shadow-lg shadow-emerald-600/20 group-hover:bg-emerald-600 group-hover:text-white transition-all">
                                <FiDollarSign />
                            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <Link href="/admin/dashboard/payouts">
                        <motion.div variants={itemVariants} className="bg-emerald-600 rounded-xl p-6 text-white shadow-lg shadow-emerald-600/20 relative overflow-hidden group cursor-pointer hover:shadow-lg shadow-emerald-600/20 transition-all">
