    ...
    if (loading) {
        return (
            <div className="flex-1 flex flex-col p-6 items-center justify-center min-h-[60vh]">
                ...
                <p className="mt-4 text-emerald-600 dark:text-white font-bold text-xs uppercase tracking-widest ">Initializing Platform Intelligence...</p>
            </div>
        );
    }
    ...
    return (
        <div className="flex-1 p-6 lg:p-10 max-w-7xl mx-auto w-full">
            ...
            <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h1 className="text-3xl md:text-4xl font-bold text-emerald-600 dark:text-white mb-2 tracking-tight">
                        نظرة عامة
                    </h1>
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <motion.div variants={itemVariants} className="relative group overflow-hidden bg-white dark:bg-card-white p-8 rounded-[2rem] shadow-lg shadow-emerald-600/20 border border-gray-100 dark:border-gray-800 hover:shadow-lg shadow-emerald-600/20 transition-all duration-500">
                        ...
                        <div className="flex justify-between items-start mb-6 relative z-10">
                            <div className="w-14 h-14 rounded-xl bg-gray-50 dark:bg-gray-800 text-emerald-600 flex items-center justify-center text-2xl shadow-lg shadow-emerald-600/20 group-hover:bg-emerald-700 group-hover:text-white transition-all">
                                <FiDollarSign />
                            </div>
                        ...
                        <p className="text-3xl font-bold text-emerald-600 dark:text-white relative z-10">
                            ${stats?.totalRevenue.toFixed(2)}
                        </p>
                    </motion.div>

                    {/* Platform Fees Card */}
                    <motion.div variants={itemVariants} className="relative group overflow-hidden bg-white dark:bg-card-white p-6 rounded-xl shadow-lg shadow-emerald-600/20 border border-gray-100 dark:border-gray-800 hover:shadow-lg shadow-emerald-600/20 hover:-translate-y-1 transition-all duration-300">
                        ...
                        <div className="flex justify-between items-start mb-4 relative z-10">
                            <div className="w-12 h-12 rounded-xl bg-purple-50 dark:bg-purple-900/20 text-emerald-600 flex items-center justify-center text-xl">
                                <FiTrendingUp />
                            </div>
                            <span className="flex items-center gap-1 text-sm font-bold text-green-500 bg-green-50 dark:bg-green-900/20 px-2 py-1 rounded-lg">
                                <FiArrowUpRight /> +8%
                    ...
                    <motion.div variants={itemVariants} className="relative group overflow-hidden bg-white dark:bg-card-white p-6 rounded-xl shadow-lg shadow-emerald-600/20 border border-gray-100 dark:border-gray-800 hover:shadow-lg shadow-emerald-600/20 hover:-translate-y-1 transition-all duration-300">
                        ...
                        <div className="flex items-baseline gap-2 relative z-10">
                            <p className="text-3xl font-bold text-emerald-600 dark:text-white">{stats?.totalOrders}</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <Link href="/admin/dashboard/payouts">
                        <motion.div variants={itemVariants} className="bg-emerald-700 rounded-xl p-6 text-white shadow-lg shadow-emerald-600/20 relative overflow-hidden group cursor-pointer hover:shadow-lg shadow-emerald-600/20 transition-all">
                            ...
                            <div className="flex items-start justify-between">
                                ...
                                <div className="w-14 h-14 rounded-xl bg-surface/10 flex items-center justify-center group-hover:bg-emerald-700 group-hover:scale-110 transition-all">
                    ...
                    <Link href="/admin/dashboard/orders?type=manual">
                        <motion.div variants={itemVariants} className="bg-white dark:bg-card-white border border-yellow-200 dark:border-yellow-900/30 rounded-xl p-6 shadow-lg shadow-emerald-600/20 relative overflow-hidden group cursor-pointer hover:border-yellow-400 transition-all">
                            ...
                            <div className="flex items-start justify-between">
                                <div>
                                    ...
                                    <div className="text-4xl font-bold mb-4 text-emerald-600 dark:text-white">{stats?.pendingManualOrders}</div>
                    ...
                    <Link href="/admin/verification">
                        <motion.div variants={itemVariants} className={`bg-white dark:bg-card-white border rounded-xl p-6 shadow-lg shadow-emerald-600/20 relative overflow-hidden group cursor-pointer transition-all ${
                            ...
                            <div className="flex items-start justify-between">
                                <div>
                                    ...
                                    <div className="text-4xl font-bold mb-4 text-emerald-600 dark:text-white">{stats?.pendingVerifications || 0}</div>
                    ...
                    <motion.div variants={itemVariants} className="bg-white dark:bg-card-white border border-gray-100 dark:border-gray-800 rounded-xl p-6 shadow-lg shadow-emerald-600/20 relative overflow-hidden group">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-700/5 rounded-xl -translate-y-1/2 translate-x-1/2 blur-2xl"></div>

                        <div className="flex items-start justify-between">
                            <div>
                                <h3 className="text-gray-500 dark:text-gray-400 font-bold mb-1">المحتوى المعروض</h3>
                                <div className="text-4xl font-bold mb-4 text-emerald-600 dark:text-white">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-10">
                    ...
                    {/* Recent Orders Table */}
                    <motion.div variants={itemVariants} className="lg:col-span-2 bg-white dark:bg-card-white rounded-xl border border-gray-100 dark:border-gray-800 shadow-lg shadow-emerald-600/20 overflow-hidden flex flex-col">
                        <div className="p-6 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center bg-gray-50/30 dark:bg-gray-900/10">
                            <h2 className="text-sm font-bold text-emerald-600 dark:text-white flex items-center gap-3 uppercase tracking-widest">
                                <FiActivity className="text-emerald-600" /> Recent Activity
                            </h2>
                            <Link href="/admin/dashboard/orders" className="text-[10px] font-bold text-emerald-600 hover:text-emerald-600 transition-colors uppercase tracking-widest">
                                View Full Report
                            </Link>
                        </div>
                                    ...
                                    {recentOrders.length === 0 ? (
                                        ...
                                        recentOrders.map((order) => (
                                            <tr key={order.id} className="border-b border-gray-50 dark:border-gray-800/60 hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors">
                                                ...
                                                <td className="py-4 px-6">
                                                    <div className="font-bold text-emerald-600 dark:text-white text-lg">
                    ...
                    <motion.div variants={itemVariants} className="bg-white dark:bg-card-white rounded-xl border border-gray-100 dark:border-gray-800 shadow-lg shadow-emerald-600/20 overflow-hidden flex flex-col">
                                        ...
                                        <div key={seller.id} className="flex items-center gap-4 relative group">
                                            ...
                                            <div className="flex-1 flex items-center gap-3">
                                                <div className="relative">
                                                    {seller.avatar ? (
                                                        <img src={seller.avatar} className="w-12 h-12 rounded-xl object-cover shadow-lg shadow-emerald-600/20 border border-gray-100 dark:border-gray-800" alt={seller.name} />
                                                    ) : (
