    ...
    return (
        <div className="min-h-screen bg-[#111111] dark:bg-gray-900">
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-white dark:text-white">📋 الطلبات اليدوية</h1>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="bg-[#0A0A0A] dark:bg-gray-800 rounded-xl p-4 border border-blue-100 dark:border-amber-900/30 shadow-lg shadow-[#10B981]/20">
                        <p className="text-xs text-[#10B981]-500 font-bold uppercase">قيد الانتظار</p>
                        <p className="text-2xl font-bold text-[#10B981] mt-1">{pendingCount}</p>
                    </div>
                    <div className="bg-[#0A0A0A] dark:bg-gray-800 rounded-xl p-4 border border-blue-100 dark:border-blue-900/30 shadow-lg shadow-[#10B981]/20">
                        <p className="text-xs text-[#10B981]-500 font-bold uppercase">مقبول</p>
                        <p className="text-2xl font-bold text-[#10B981]-600 mt-1">{approvedCount}</p>
                    </div>
                    <div className="bg-[#0A0A0A] dark:bg-gray-800 rounded-xl p-4 border border-red-100 dark:border-red-900/30 shadow-lg shadow-[#10B981]/20">
                                    ...
                                    <div className="p-6">
                                        <div className="grid md:grid-cols-3 gap-6">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <p className="font-bold text-white dark:text-white">{order.customerName}</p>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <p className="font-bold text-lg text-white dark:text-white">${order.totalAmount.toFixed(2)}</p>
                                                ...
                                                {order.paymentNotes && (
                                                    <p className="text-xs text-gray-500 bg-[#111111] dark:bg-gray-900 p-2 rounded-lg mt-1">{order.paymentNotes}</p>
                                                )}
                                            </div>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                {order.paymentProof && (
                                                    <button
                                                        ...
                                                        className="mt-2 flex items-center gap-2 text-xs text-[#10B981] font-bold hover:underline"
                                                    >
                                        ...
                                        {isPending && (
                                            <div className="mt-6 pt-4 border-t border-white/10 dark:border-gray-700 flex gap-3">
                                                ...
                                                <button
                                                    ...
                                                    className="flex-1 px-4 py-2.5 bg-red-600 text-white rounded-xl hover:bg-red-700 transition-colors flex items-center justify-center gap-2 font-bold text-sm shadow-lg shadow-[#10B981]/20"
                                                >
                                                    <FiX /> رفض
                                                </button>
                                            </div>
            ...
            {selectedOrder && (
                <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onClick={() => setSelectedOrder(null)}>
                    <div className="bg-[#0A0A0A] dark:bg-gray-800 rounded-xl p-6 max-w-md w-full shadow-lg shadow-[#10B981]/20" onClick={e => e.stopPropagation()}>
