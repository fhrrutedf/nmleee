        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="py-16">
                <div className="max-w-4xl mx-auto px-4 prose prose-lg text-gray-700">
                    <h2 className="text-2xl font-bold text-emerald-600 mb-4">1. المعلومات التي نجمعها</h2>
                    <p className="mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-emerald-600 mb-4">2. كيف نستخدم معلوماتك</h2>
                    <p className="mb-6">
                        نستخدم البيانات لتقديم خدماتنا وتحسينها، معالجة المعاملات، إرسال التنبيهات، ومنع الاحتيال.
                    </p>

                    <h2 className="text-2xl font-bold text-emerald-600 mb-4">3. مشاركة البيانات</h2>
                    <p className="mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-emerald-600 mb-4">4. أمن المعلومات</h2>
                    <p className="mb-6">
                        نستخدم تدابير أمنية متقدمة لحماية معلوماتك من الوصول غير المصرح به أو التعديل أو الكشف.
                    </p>

                    <h2 className="text-2xl font-bold text-emerald-600 mb-4">5. ملفات تعريف الارتباط (Cookies)</h2>
                    <p className="mb-6">
                        نستخدم ملفات تعريف الارتباط لتحسين تجربتك، تحليل حركة المرور، وتخصيص المحتوى.
                    </p>

                    <h2 className="text-2xl font-bold text-emerald-600 mb-4">6. حقوقك</h2>
                    <p className="mb-6">
