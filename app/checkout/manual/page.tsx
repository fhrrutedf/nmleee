        ...
        <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0F172A]">
            ...
            <header className="bg-[#0A0A0A] dark:bg-[#1e293b] shadow-lg shadow-[#10B981]/20 sticky top-0 z-20 border-b border-white/10 dark:border-gray-800">
                <div className="max-w-xl mx-auto px-4 py-3.5 flex items-center gap-3">
                    ...
                    <div className="mr-auto flex items-center gap-1.5 text-[11px] text-[#10B981]-600 bg-emerald-700 text-white-50 dark:bg-blue-900/20 px-2.5 py-1 rounded-xl font-semibold">
                        <FiShield size={12} />
                        <span>آمن</span>
                    </div>
                </div>
            ...
            <div className="max-w-xl mx-auto px-4 py-5 pb-20">
                            ...
                            <div className="space-y-2.5">
                                {[
                                    ...
                                    <div key={i} className="flex gap-2.5">
                                        <div className="w-6 h-6 shrink-0 rounded-xl bg-[#0052FF] text-white flex items-center justify-center text-[10px] font-bold">{i + 1}</div>
                        ...
                        <div className="bg-[#0A0A0A] dark:bg-[#1e293b] rounded-xl border border-white/10 dark:border-gray-800 p-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className={`shrink-0 w-11 h-11 rounded-xl flex items-center justify-center transition-all ${copied ? 'bg-emerald-700 text-white-500 text-white' : 'bg-[#0052FF] text-white hover:bg-[#0052FF]/90 active:scale-95'}`}
                                >
                ...
                {step === 3 && orderResult && (
                    <div className="text-center py-6 animate-in fade-in">
                        ...
                        <div className="bg-emerald-700 text-white-50 dark:bg-amber-900/20 text-blue-700 dark:text-amber-400 rounded-xl p-3.5 text-xs font-medium flex items-start gap-2.5 text-right max-w-sm mx-auto mb-6">
                        ...
                        <div className="flex gap-2.5 justify-center">
                            ...
                            <Link href="/explore" className="bg-emerald-800 dark:bg-gray-800 text-gray-400 dark:text-gray-300 px-5 py-2.5 rounded-xl font-bold text-xs hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
                                تابع التسوق
                            </Link>
                        </div>
                    </div>
