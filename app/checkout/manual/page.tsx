        ...
        <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0F172A]">
            ...
            <header className="bg-white dark:bg-[#1e293b] shadow-sm sticky top-0 z-20 border-b border-gray-100 dark:border-gray-800">
                <div className="max-w-xl mx-auto px-4 py-3.5 flex items-center gap-3">
                    ...
                    <div className="mr-auto flex items-center gap-1.5 text-[11px] text-emerald-600-600 bg-emerald-600-50 dark:bg-blue-900/20 px-2.5 py-1 rounded-xl font-semibold">
                        <FiShield size={12} />
                        <span>آمن</span>
                    </div>
                </div>
            ...
            <div className="max-w-xl mx-auto px-4 py-5 pb-20">
                        ...
                        <div className="bg-white dark:bg-[#1e293b] rounded-xl border border-gray-100 dark:border-gray-800 p-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className={`shrink-0 w-11 h-11 rounded-xl flex items-center justify-center transition-all ${copied ? 'bg-emerald-600-500 text-white' : 'bg-[#0052FF] text-white hover:bg-[#0052FF]/90 active:scale-95'}`}
                                >
                ...
                {step === 3 && orderResult && (
                    <div className="text-center py-6 animate-in fade-in">
                        ...
                        <div className="bg-emerald-600-50 dark:bg-amber-900/20 text-blue-700 dark:text-amber-400 rounded-xl p-3.5 text-xs font-medium flex items-start gap-2.5 text-right max-w-sm mx-auto mb-6">
