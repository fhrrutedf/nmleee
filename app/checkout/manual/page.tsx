                        ...
                        <div className="bg-[#0A0A0A] dark:bg-[#1e293b] rounded-xl border border-gray-100 dark:border-gray-800 p-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className={`shrink-0 w-11 h-11 rounded-xl flex items-center justify-center transition-all ${copied ? 'bg-emerald-700-500 text-white' : 'bg-[#0052FF] text-white hover:bg-[#0052FF]/90 active:scale-95'}`}
                                >
