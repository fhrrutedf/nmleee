...
export default function LearnPage() {
        ...
        return (
            <div className="min-h-screen bg-gray-950 flex items-center justify-center p-6 text-right" dir="rtl">
                <div className="max-w-md w-full p-10 bg-gray-900 border border-white/5 rounded-xl shadow-lg shadow-emerald-600/20">
                    ...
                    <button onClick={() => router.push('/courses')} className="w-full py-4 bg-emerald-700-600 hover:bg-emerald-700-500 text-white rounded-xl font-bold transition-all flex items-center justify-center gap-3">
    ...
    return (
        <div className="min-h-screen bg-gray-950 flex flex-col h-screen overflow-hidden text-right selection:bg-emerald-700-500/30" dir="rtl">
            ...
            <header className="h-16 md:h-20 bg-gray-900/80  border-b border-white/5 px-4 md:px-8 flex items-center justify-between z-30 shrink-0">
                <div className="flex items-center gap-4">
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-emerald-700-600 flex items-center justify-center text-white">
                            <FiAward size={16} />
                        </div>
                ...
                <div className="flex items-center gap-3">
                    <div className="hidden sm:flex flex-col items-end gap-1.5 ml-4">
                        ...
                        <div className="w-32 h-1.5 bg-white/5 rounded-xl overflow-hidden">
                            <div className="h-full bg-emerald-700-500 rounded-xl transition-all duration-1000" style={{ width: `${progressPercent}%` }} />
                        </div>
                    </div>
                    <button 
