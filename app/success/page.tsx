    ...
    if (!order) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-[#111111]">
                <h1 className="text-2xl font-bold mb-4 text-[#10B981]">طلب غير موجود</h1>
            ...
            <div className="max-w-5xl mx-auto px-6">
                <div className="bg-[#0A0A0A] rounded-[2.5rem] shadow-lg shadow-[#10B981]/20 shadow-gray-200/50 overflow-hidden border border-gray-100 flex flex-col">
                    ...
                    {isPending && !isPaid ? (
                        <div className="bg-emerald-700 text-white p-16 text-center relative overflow-hidden">
                            <div className="relative z-10">
                                <div className="w-20 h-20 bg-[#0A0A0A]/10 rounded-xl flex items-center justify-center mx-auto mb-8 ">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        ...
                        <div className="p-10 md:p-16 border-l border-gray-50 flex flex-col">
                            ...
                            <div className="bg-[#111111] rounded-xl p-8 space-y-6 mb-10 border border-gray-100">
                                ...
                                <div className="flex justify-between items-center pt-3">
                                    <span className="text-[#10B981] font-bold text-lg">إجمالي المبلغ:</span>
                                    <span className="font-bold text-[#10B981] text-3xl font-inter tracking-tighter">${order.totalAmount.toFixed(2)}</span>
                                </div>
                            </div>
                            ...
                            <div className="mt-auto space-y-4">
                                {isPaid || (!isPending) ? (
                                    ...
                                    <Link
                                        href="/market"
                                        className="flex items-center justify-center gap-3 w-full py-5 bg-emerald-700 text-white rounded-xl font-bold transition-all shadow-lg shadow-[#10B981]/20 shadow-ink/10 hover:bg-gray-800"
                                    >
                                        العودة للمتجر
                                    </Link>
                                )}
                        ...
                        <div className="p-10 md:p-16 bg-[#111111]/30 flex flex-col">
                            <div className="mb-12">
                                <h3 className="text-xl font-bold text-[#10B981] mb-6 flex items-center gap-3">
                                    <FiMessageCircle className="text-[#10B981]" /> قنوات تواصل رسمية
                                </h3>
                                ...
                                <div className="grid grid-cols-1 gap-3">
                                    {socialLinks.map((link, i) => (
                                        ...
                                        >
                                            ...
                                            <FiArrowLeft className="text-gray-300 group-hover:text-[#10B981] group-hover:-translate-x-1 transition-all" />
                                        </a>
                                    ))}
                                </div>
                            </div>
                                        ...
                                        {upsells.map((upsell) => (
                                            <Link key={upsell.id} href={`/${upsell.id}`} className="bg-[#0A0A0A] border border-gray-100 p-4 rounded-xl flex items-center justify-between hover:border-emerald-600 group transition-all">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <h4 className="font-bold text-[#10B981] text-xs line-clamp-1 group-hover:text-[#10B981] transition-colors">{upsell.title}</h4>
