...
export default function BlogListClient({ initialPosts }: { initialPosts: any[] }) {
    ...
    return (
        <div className="min-h-screen bg-[#0A0A0A] selection:bg-emerald-700 text-white/20" dir="rtl">
                    ...
                    {filteredPosts.length > 0 ? (
                        ...
                        <div className="text-center py-40 bg-[#111111] rounded-[3rem] border-2 border-dashed border-gray-100 p-8">
                            ...
                            <button
                                ...
                                className="px-10 py-4 bg-emerald-700 text-white rounded-xl font-bold text-[10px] uppercase tracking-widest hover:bg-emerald-700 text-white transition-all shadow-lg shadow-[#10B981]/20 shadow-ink/10"
                            >
                                Reset All Filters
                            </button>
                        </div>
