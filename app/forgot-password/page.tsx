...
export default function ForgotPasswordPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-bg-light relative overflow-hidden py-12 px-4">
            ...
            <div className="absolute top-[-10%] right-[-5%] w-[400px] h-[400px] bg-emerald-700 text-white/10 rounded-xl blur-[80px] -z-10 pointer-events-none"></div>
            ...
            >
                ...
                <motion.div variants={fadeInUp} className="text-center mb-10">
                    <Link href="/" className="inline-block mb-6">
                        <div className="w-16 h-16 mx-auto rounded-xl bg-emerald-700 text-white flex items-center justify-center text-white shadow-lg shadow-[#10B981]/20 shadow-accent/20">
