            ...
            <nav className="max-w-6xl mx-auto px-4 sm:px-6 py-3.5">
                <div className="flex items-center justify-between">
                        ...
                        <div className="hidden lg:flex items-center gap-6">
                            {navLinks.map((link, idx) => (
                                <Link
                                    key={idx}
                                    href={link.href}
                                    className={`text-sm font-medium transition-colors ${pathname === link.href ? 'text-[#10B981]' : 'text-gray-500 hover:text-[#10B981]'}`}
                                >
                                    {link.title}
                                </Link>
                            ))}
                    ...
                    <div className="hidden md:flex items-center gap-2">
                        <Link href="/login" className="px-6 py-2.5 text-[10px] font-bold text-gray-400 hover:text-[#10B981] transition-colors uppercase tracking-[0.2em]">
                            Portal
                        </Link>
                        <Link
                            href="/register"
