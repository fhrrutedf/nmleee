        ...
        <div className="space-y-6 max-w-6xl mx-auto pb-12">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                    ...
                    className="btn btn-primary py-3 px-6 shadow-xl shadow-action-blue/20 flex items-center gap-2"
                >
                    <FiPlus /> تذكرة جديدة
                </button>
            </div>
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                                {tickets.map(ticket => (
                                    <tr key={ticket.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                        <td className="px-6 py-4 font-mono text-action-blue font-bold">
                                            {ticket.ticketNumber}
                                        </td>
                                        <td className="px-6 py-4 font-bold text-primary-charcoal dark:text-gray-100 max-w-xs truncate">
                                            {ticket.subject}
                                        </td>
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <Link href={`/dashboard/support/${ticket.id}`} className="text-action-blue hover:text-blue-700 font-bold underline text-sm">
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex justify-center items-center p-4">
                    <div className="bg-white dark:bg-card-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden transform transition-all">
                        <div className="p-6 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center bg-gray-50 dark:bg-gray-900/50">
                            <h2 className="text-xl font-bold text-primary-charcoal dark:text-white flex items-center gap-2">
                                <FiPlus className="text-action-blue" /> فتح تذكرة درعم جديدة
                            </h2>
