                            ...
                            filteredStudents.map((student) => (
                                <tr key={student.id} className="hover:bg-[#111111] dark:hover:bg-gray-800/30 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-xl h-2 min-w-[100px] max-w-[150px]">
                                                <div
                                                    className={`h-2 rounded-xl ${student.isCompleted ? 'bg-green-500' : 'bg-emerald-700 text-white'}`}
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            <button
                                                className="p-2 text-[#10B981] hover:bg-emerald-700 text-white/10 rounded-lg transition-colors"
                                                title="إرسال رسالة"
                                            >
                                                <FiMail />
                                            </button>
