    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-[#10B981] dark:text-white">الباقات والحزم</h1>
            ...
            {bundles && bundles.length === 0 ? (
                <div className="bg-[#0A0A0A] dark:bg-card-white rounded-xl border border-dashed border-gray-300 dark:border-gray-700 p-12 text-center">
                    ...
                    <h3 className="text-xl font-bold text-[#10B981] dark:text-white mb-2">لا توجد باقات بعد</h3>
                    ...
                    {bundles?.map((bundle) => (
                        <div key={bundle.id} className="bg-[#0A0A0A] dark:bg-card-white rounded-xl border border-gray-100 dark:border-gray-800 shadow-lg shadow-[#10B981]/20 overflow-hidden flex flex-col hover:shadow-md transition-shadow">
                            ...
                            <div className="p-5 flex-1 flex flex-col">
                                <h3 className="text-lg font-bold text-white dark:text-white mb-1 line-clamp-1">{bundle.title}</h3>
