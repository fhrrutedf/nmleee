                                ...
                                {products?.map((product) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`p-4 rounded-xl cursor-pointer border-2 transition-all flex items-start gap-4 ${isSelected ? 'border-emerald-600 bg-emerald-700 text-white/5' : 'border-gray-100 hover:border-emerald-600/30 dark:border-gray-800'}`}
                                        >
