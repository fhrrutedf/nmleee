        ...
        <div className="max-w-5xl mx-auto space-y-6 pb-12">
            <div className="mb-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                    <div className="w-12 h-12 bg-emerald-700 text-white/10 rounded-xl flex items-center justify-center shrink-0">
                        <FiPackage className="text-xl text-[#10B981]" />
                    </div>
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-bold text-[#10B981] dark:text-white">إنشاء باقة جديدة</h1>
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="col-span-1 lg:col-span-2 space-y-6">
                    <div className="card space-y-6 bg-[#0A0A0A] dark:bg-card-white rounded-xl p-6 md:p-8 shadow-lg shadow-[#10B981]/20 border border-white/10 dark:border-gray-800">
                            ...
                            <div>
                                ...
                                {formData.image ? (
                                    <div className="relative inline-block">
                                        <img src={formData.image} alt="Preview" className="w-full max-w-sm h-64 object-cover rounded-xl border-2 border-white/10 shadow-lg shadow-[#10B981]/20" />
                                        <button
                                            type="button"
                                            onClick={() => setFormData({ ...formData, image: '' })}
                                            className="absolute -top-3 -right-3 bg-red-500/100/100 text-white p-2.5 rounded-xl hover:bg-red-600 transition-colors shadow-lg shadow-[#10B981]/20"
                                        >
                                            <FiX />
                                        </button>
                                    </div>
                    ...
                    <div className="card space-y-6 bg-[#0A0A0A] dark:bg-card-white rounded-xl p-6 md:p-8 shadow-lg shadow-[#10B981]/20 border border-white/10 dark:border-gray-800">
                        <h2 className="text-xl font-bold border-b border-white/10 dark:border-gray-800 pb-4 mb-4">المنتجات المشمولة في الباقة</h2>
                                ...
                                {products?.map((product) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`p-4 rounded-xl cursor-pointer border-2 transition-all flex items-start gap-4 ${isSelected ? 'border-emerald-600 bg-emerald-700 text-white/5' : 'border-white/10 hover:border-emerald-600/30 dark:border-gray-800'}`}
                                        >
                ...
                <div className="col-span-1 border-white/10">
                    <div className="sticky top-24 space-y-6">
                        <div className="bg-[#0A0A0A] dark:bg-card-white rounded-xl p-6 shadow-lg shadow-[#10B981]/20 shadow-gray-100 dark:shadow-gray-900 border border-white/10 dark:border-gray-800 relative overflow-hidden">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-emerald-700 text-white/5 p-4 rounded-xl border border-emerald-600/10">
