    ...
    return (
        <div className="space-y-8 pb-32 max-w-7xl mx-auto px-4 md:px-0" dir="rtl">
            ...
            <div className="relative overflow-hidden bg-[#0A0A0A] dark:bg-card-white rounded-xl p-1 shadow-lg shadow-[#10B981]/20 border border-slate-50 dark:border-gray-800">
                ...
                <div className="relative p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-12">
                    <div className="max-w-xl text-center md:text-right">
                        <span className="px-4 py-1.5 bg-[#0A0A0A] dark:bg-primary-indigo-900/40 text-primary-ink dark:text-primary-indigo-300 rounded-xl text-xs font-bold uppercase tracking-widest mb-6 inline-block">
                            برنامج شركاء النجاح 💎
                        </span>
                        <h1 className="text-3xl md:text-4xl font-bold text-white dark:text-white leading-[1.2] mb-4">اكسب عمولتك فوراً <br/> مع كل إحالة ناجحة!</h1>
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch gap-4">
                             ...
                             <button 
                                onClick={copyLink}
                                className={`px-10 h-16 rounded-xl font-bold text-sm flex items-center justify-center gap-3 transition-all ${copied ? 'bg-emerald-700-500 text-white shadow-blue-200' : 'bg-emerald-700 text-white shadow-lg shadow-[#10B981]/20 shadow-primary-indigo-100 hover:bg-primary-indigo-700 active:scale-95'}`}
                             >
                    ...
                    <div className="relative shrink-0 md:ml-12">
                        <div className="w-48 h-48 bg-emerald-700 rounded-xl rotate-12 flex items-center justify-center shadow-lg shadow-[#10B981]/20 shadow-primary-indigo-400 -slow">
                        ...
                        <div className="absolute -bottom-4 -right-4 bg-[#0A0A0A] dark:bg-gray-900 p-4 rounded-xl shadow-lg shadow-[#10B981]/20 flex items-center gap-3 border border-slate-50 dark:border-gray-800 rotate-[-8deg] ">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-bold text-[#10B981]-600">نسبة {stats?.commissionRate || 1}%</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                 {[
                    { label: 'إجمالي الأرباح', val: `${stats?.totalEarnings?.toFixed(2) || '0.00'} $`, icon: FiDollarSign, color: 'text-[#10B981]-500', bg: 'bg-emerald-700-50 dark:bg-blue-900/10' },
                    { label: 'عدد الإحالات', val: stats?.totalReferrals || 0, icon: FiUsers, color: 'text-primary-ink', bg: 'bg-[#0A0A0A] dark:bg-primary-indigo-900/10' },
                    ...
                    >
                        ...
                        <p className="text-3xl font-bold text-white dark:text-white leading-tight">{card.val}</p>
                    </motion.div>
                 ))}
            </div>
            ...
            <div className="bg-[#0A0A0A] dark:bg-card-white rounded-xl border border-slate-50 dark:border-gray-800 shadow-lg shadow-[#10B981]/20 overflow-hidden">
                ...
                {affiliates.length === 0 ? (
                    <div className="py-24 flex flex-col items-center text-center">
                        <div className="w-24 h-24 bg-[#111111] dark:bg-gray-900 rounded-xl flex items-center justify-center text-slate-300 mb-6"><FiUsers size={40} /></div>
                    ...
                    <div className="overflow-x-auto overflow-visible">
                        <table className="w-full text-right border-collapse">
                            <thead>
                                <tr className="bg-[#111111]/50 dark:bg-gray-900/50">
                                    <th className="py-5 px-8 text-xs font-bold text-gray-500 uppercase">التاريخ</th>
                                    <th className="py-5 px-8 text-xs font-bold text-gray-500 uppercase">المنتج المُباع</th>
                                    <th className="py-5 px-8 text-xs font-bold text-gray-500 uppercase">القيمة</th>
                                    <th className="py-5 px-8 text-xs font-bold text-gray-500 uppercase text-left">عمولتك $</th>
                                </tr>
                            </thead>
                            <tbody>
                                {affiliates.map((aff: any, i: number) => (
                                    ...
                                    >
                                        ...
                                        <td className="py-6 px-8 text-sm font-bold text-gray-500">{aff.amount.toFixed(2)} $</td>
                                        <td className="py-6 px-8 text-left">
                                            <span className="inline-flex items-center h-10 px-6 rounded-xl bg-emerald-700-50 dark:bg-blue-900/20 text-[#10B981]-600 font-bold text-sm">
            ...
            <div className="bg-primary-indigo-900 text-white rounded-xl p-12 relative overflow-hidden group">
                ...
                <div className="relative flex flex-col md:flex-row items-center gap-12">
                    <div className="w-20 h-20 bg-[#0A0A0A]/10 rounded-xl flex items-center justify-center text-primary-indigo-300 shrink-0"><FiInfo size={40} /></div>
