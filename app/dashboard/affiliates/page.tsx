    ...
    return (
        <div className="space-y-8">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-[#10B981] dark:text-white flex items-center gap-2">
                        <FiUsers className="text-[#10B981]" /> نظام التسويق بالعمولة
                    </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-[#0A0A0A] dark:bg-card-white border border-white/10 dark:border-gray-800 rounded-xl p-6 shadow-lg shadow-[#10B981]/20 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h4 className="text-3xl font-bold text-[#10B981] dark:text-white">{affiliates.reduce((acc, curr) => acc + curr.commission, 0)} <span className="text-sm">$</span></h4>
                    </div>
                </div>
            </div>
            ...
            {/* Affiliates List */}
            {affiliates.length === 0 ? (
                <div className="bg-[#0A0A0A] dark:bg-card-white rounded-xl border border-dashed border-gray-300 dark:border-gray-700 p-12 text-center">
                    <div className="w-20 h-20 bg-[#111111] dark:bg-gray-800 rounded-xl flex items-center justify-center mx-auto mb-6">
                        <FiLink className="text-3xl text-gray-400" />
                    </div>
                    <h3 className="text-xl font-bold text-[#10B981] dark:text-white mb-2">لا يوجد مسوقين مضافين حالياً</h3>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-right border-collapse">
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                                {affiliates.map((link) => (
                                    <tr key={link.id} className="hover:bg-[#111111] dark:hover:bg-gray-800/50 transition-colors">
                                        <td className="px-6 py-5 whitespace-nowrap">
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 text-[#10B981] rounded-xl flex items-center justify-center font-bold">
                                                    {link.user?.name?.charAt(0) || <FiUsers />}
                                                </div>
                                                <div>
                                                    <p className="font-bold text-white dark:text-white">{link.user?.name || "مستخدم غير معرف"}</p>
