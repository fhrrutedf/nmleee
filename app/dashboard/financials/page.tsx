...
const planBadge: Record<string, { label: string; color: string; bg: string; icon: string }> = {
    FREE: { label: 'مجانية', color: 'text-gray-400', bg: 'bg-emerald-800 dark:bg-gray-800', icon: '🆓' },
    GROWTH: { label: 'Growth', color: 'text-[#10B981]-600', bg: 'bg-emerald-700 text-white-50 dark:bg-blue-900/20', icon: '🚀' },
...
export default function FinancialsPage() {
    ...
    const getItemIcon = (type: string) => {
        switch (type) {
            ...
            default: return <FiShoppingBag className="text-[#10B981]-500" />;
        }
    };
            ...
            {activeTab === 'overview' ? (
                <>
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <motion.div variants={item} className="bg-[#0A0A0A] dark:bg-card-white rounded-xl shadow-lg shadow-[#10B981]/20 border border-white/10 dark:border-gray-800 p-6 relative overflow-hidden group hover:shadow-lg shadow-[#10B981]/20 transition-all hover:-translate-y-1">
                            ...
                            <div className="relative">
                                ...
                                <p className="text-3xl font-bold text-[#10B981] dark:text-white tracking-tight">
                        ...
                        <motion.div variants={item} className="bg-[#0A0A0A] dark:bg-card-white rounded-xl shadow-lg shadow-[#10B981]/20 border border-white/10 dark:border-gray-800 p-6 relative overflow-hidden group hover:shadow-lg shadow-[#10B981]/20 transition-all hover:-translate-y-1">
                            ...
                            <div className="relative">
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900/20 text-[#10B981]-600 rounded-xl flex items-center justify-center">
                        ...
                        <motion.div variants={item} className="bg-emerald-700 text-white rounded-xl shadow-lg shadow-[#10B981]/20 p-6 relative overflow-hidden group hover:shadow-lg shadow-[#10B981]/20 transition-all hover:-translate-y-1">
                            <div className="absolute top-0 right-0 w-28 h-28 bg-[#0A0A0A]/10 rounded-xl blur-2xl -mr-8 -mt-8" />
                            <div className="relative">
                                <div className="flex items-center justify-between mb-3">
                            ...
                            <table className="w-full text-right">
                                ...
                                <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                                    {data.monthlyChart.labels.map((month, idx) => (
                                        <tr key={idx} className="hover:bg-[#111111] dark:hover:bg-gray-800/50 transition-colors">
                                            <td className="px-6 py-4 font-bold text-[#10B981] dark:text-white text-sm">{month}</td>
                                            <td className="px-6 py-4 text-green-600 font-bold text-sm">{data.monthlyChart.data[idx].toFixed(2)} $</td>
                                            <td className="px-6 py-4 text-gray-400 dark:text-gray-300 text-sm">{data.monthlyChart.orders[idx]} طلب</td>
                    ...
                    <motion.div variants={item} className="bg-[#0A0A0A] dark:bg-card-white rounded-xl shadow-lg shadow-[#10B981]/20 border border-white/10 dark:border-gray-800 overflow-hidden">
                        <div className="p-6 border-b border-white/10 dark:border-gray-800 flex justify-between items-center">
                            ...
                            <Link href="/dashboard/earnings" className="text-sm font-bold text-[#10B981] hover:text-[#10B981] flex items-center gap-1">
                        ...
                        {data.recentTransactions.length === 0 ? (
                            <div className="p-12 text-center">
                                <div className="w-16 h-16 bg-[#111111] dark:bg-gray-800 rounded-xl flex items-center justify-center mx-auto mb-4">
                            ...
                            <div className="divide-y divide-gray-100 dark:divide-gray-800">
                                {data.recentTransactions.map((tx, idx) => (
                                    <div key={idx} className="flex items-center gap-4 px-6 py-4 hover:bg-[#111111] dark:hover:bg-gray-800/50 transition-colors">
                                        <div className="w-10 h-10 bg-[#111111] dark:bg-gray-800 rounded-xl flex items-center justify-center">
                                            {getItemIcon(tx.itemType)}
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <p className="font-bold text-sm text-[#10B981] dark:text-white truncate">{tx.item}</p>
                    ...
                    <motion.div variants={item} className="grid sm:grid-cols-3 gap-4">
                        <Link href="/dashboard/payouts" className="card flex items-center gap-4 hover:shadow-lg shadow-[#10B981]/20 transition-all hover:-translate-y-1 group">
                            ...
                            <div>
                                <h3 className="font-bold text-[#10B981] dark:text-white">طلب سحب الأرباح</h3>
                                <p className="text-xs text-text-muted">اسحب رصيدك المتاح</p>
                            </div>
                        </Link>
                        <Link href="/dashboard/earnings" className="card flex items-center gap-4 hover:shadow-lg shadow-[#10B981]/20 transition-all hover:-translate-y-1 group">
                            <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/20 text-[#10B981]-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                                <FiTrendingUp size={24} />
                            </div>
                            <div>
                                <h3 className="font-bold text-[#10B981] dark:text-white">تفاصيل الأرباح</h3>
                                <p className="text-xs text-text-muted">سجل المعاملات الكامل</p>
                            </div>
                        </Link>
                        <Link href="/dashboard/analytics" className="card flex items-center gap-4 hover:shadow-lg shadow-[#10B981]/20 transition-all hover:-translate-y-1 group">
                            <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900/20 text-[#10B981] rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                                <FiPieChart size={24} />
                            </div>
                            <div>
                                <h3 className="font-bold text-[#10B981] dark:text-white">التحليلات الكاملة</h3>
                ...
                <>
                    ...
                    <div className="grid sm:grid-cols-3 gap-6">
                        <motion.div variants={item} className="bg-emerald-700 text-white rounded-xl shadow-lg shadow-[#10B981]/20 p-6 relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-24 h-24 bg-[#0A0A0A]/10 rounded-xl blur-2xl -mr-8 -mt-8" />
                            <div className="relative">
                                <div className="flex items-center justify-between mb-3">
                            ...
                            <button
                                ...
                                className={`px-6 py-3 rounded-xl font-bold text-sm transition-all whitespace-nowrap ${
                                    copied
                                        ...
                                        : 'bg-emerald-700 text-white hover:bg-emerald-700 text-white'
                                }`}
                            >
                    ...
                    <motion.div variants={item} className="bg-[#0A0A0A] dark:bg-card-white rounded-xl shadow-lg shadow-[#10B981]/20 border border-white/10 dark:border-gray-800 p-8">
                        ...
                        <div className="grid sm:grid-cols-3 gap-6">
                            <div className="text-center p-4">
                                <div className="w-16 h-16 bg-emerald-700 text-white-50 dark:bg-blue-900/20 rounded-xl flex items-center justify-center mx-auto mb-4">
                                    <span className="text-3xl">1️⃣</span>
                                </div>
                                <h3 className="font-bold text-[#10B981] dark:text-white mb-2">شارك رابط الإحالة</h3>
                            ...
                            <div className="text-center p-4">
                                ...
                                <h3 className="font-bold text-[#10B981] dark:text-white mb-2">يسجّلون ويبيعون</h3>
                            ...
                            <div className="text-center p-4">
                                ...
                                <h3 className="font-bold text-[#10B981] dark:text-white mb-2">تكسب تلقائياً</h3>
                                <p className="text-sm text-gray-500">تحصل على 1% من عمولة المنصة على كل بيعة يتمها المُحال</p>
                            </div>
                        </div>

                        <div className="mt-6 bg-emerald-700 text-white dark:from-purple-900/10 dark:to-blue-900/10 rounded-xl p-5 border border-purple-200/50 dark:border-purple-800/50">
                            <h4 className="font-bold text-[#10B981] dark:text-white mb-2">💡 مثال توضيحي</h4>
