    ...
    return (
        <div className="space-y-8 pb-16">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-bold text-ink">🎨 الهوية البصرية</h1>
                ...
                <div className="flex gap-3">
                    {brand.username && (
                        <Link
                            href={`/${brand.username}`}
                            target="_blank"
                            className="flex items-center gap-2 px-5 py-3 bg-white border border-gray-200 rounded-xl font-bold text-sm text-gray-600 hover:border-gray-300 transition-all shadow-sm"
                        >
                            <FiEye /> معاينة المتجر
                        </Link>
                    )}
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white rounded-3xl border border-gray-100 p-6 sm:p-8 shadow-sm">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <div>
                                <h2 className="text-lg font-bold text-ink">الألوان</h2>
                    ...
                    <div className="bg-white rounded-3xl border border-gray-100 p-6 sm:p-8 shadow-sm">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <div>
                                <h2 className="text-lg font-bold text-ink">الخطوط</h2>
                    ...
                    <div className="bg-white rounded-3xl border border-gray-100 p-6 sm:p-8 shadow-sm">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <div>
                                <h2 className="text-lg font-bold text-ink">شكل الأزرار</h2>
                    ...
                    <div className="bg-white rounded-3xl border border-gray-100 p-6 sm:p-8 shadow-sm">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <div>
                                <h2 className="text-lg font-bold text-ink">شعار المتجر والوصف</h2>
                    ...
                    <div className="sticky top-28 space-y-6">
                        ...
                        <div className="bg-white rounded-3xl border border-gray-100 shadow-2xl overflow-hidden transition-all duration-500">
                            ...
                            <div className="px-6 pt-4 pb-8">
                                <h4 className="font-bold text-ink text-lg tracking-tight">{brand.name || 'اسم متجرك'}</h4>
