    ...
    return (
        <div className="space-y-8 pb-16">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-bold text-[#10B981]">🎨 الهوية البصرية</h1>
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        onClick={saveBrand}
                        disabled={saving}
                        className="flex items-center gap-2 px-6 py-3 bg-emerald-700 text-white rounded-xl font-bold text-sm shadow-lg shadow-[#10B981]/20 shadow-ink/10 hover:bg-gray-800 transition-all disabled:opacity-60"
                    >
                            ...
                            {COLOR_PALETTES.map((p, i) => (
                                ...
                                >
                                    <div className="flex gap-1.5 justify-center mb-3">
                                        ...
                                        <div className="w-8 h-8 rounded-lg shadow-lg shadow-[#10B981]/20" style={{ background: p.secondary }} />
                                    </div>
                    ...
                    <div className="sticky top-28 space-y-6">
                        ...
                        <div className="bg-[#0A0A0A] rounded-xl border border-gray-100 shadow-lg shadow-[#10B981]/20 overflow-hidden transition-all duration-500">
                            ...
                            <div className="px-6 -mt-10 relative z-10">
                                <div
                                    className="w-20 h-20 rounded-xl border-4 border-white shadow-lg shadow-[#10B981]/20 overflow-hidden flex items-center justify-center text-white text-2xl font-bold"
                            ...
                            <div className="px-6 pt-4 pb-8">
                                <h4 className="font-bold text-[#10B981] text-lg tracking-tight">{brand.name || 'اسم متجرك'}</h4>
                                    ...
                                    {['دورة احترافية الرقمية', 'كتاب استراتيجيات البيع'].map((t, i) => (
                                        <div key={i} className="flex items-center gap-4 p-3 rounded-xl bg-[#111111] border border-gray-100">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="text-[11px] font-bold text-[#10B981] truncate">{t}</div>
                                ...
                                <button
                                    className="w-full mt-6 py-3.5 text-white text-xs font-bold shadow-lg shadow-[#10B981]/20 transition-transform active:scale-95"
                                    style={{ background: brand.brandColor, borderRadius: btnRadius }}
                                >
                                    عرض كافة المنتجات
                                </button>
                        ...
                        <div className="bg-[#111111] rounded-xl p-5 border border-gray-100">
                             ...
                             <div className="flex items-center gap-3 mt-2">
                                ...
                                <span className="text-[10px] font-bold font-inter text-[#10B981] uppercase tracking-widest">{brand.brandSecondaryColor}</span>
                             </div>
                        </div>
                    </div>
                </div>
