    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-[#10B981] dark:text-white">الطلبات</h1>
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                                {filteredOrders.map((order: any, idx) => (
                                    <motion.tr
                                        ...
                                        className="hover:bg-[#111111] dark:hover:bg-gray-800/50 transition-colors"
                                    >
                                        <td className="py-4 px-6 font-mono text-sm text-text-muted">
                                            #{order.orderNumber || order.id.slice(0, 8)}
                                        </td>
                                        <td className="py-4 px-6 text-sm text-[#10B981] dark:text-gray-300">
                                        ...
                                        <td className="py-4 px-6 text-sm">
                                            <div className="font-medium text-[#10B981] dark:text-white">{order.customerName || 'عميل زائر'}</div>
                                            <div className="text-xs text-text-muted">{order.customerEmail}</div>
                                        </td>
                                        <td className="py-4 px-6">
                                            <div className="space-y-1">
                                                {order.items?.map((item: any) => (
                                                    <div key={item.id} className="text-sm text-[#10B981] dark:text-gray-300">
                                        ...
                                        <td className="py-4 px-6 text-sm">
                                            {order.affiliateLink?.user?.name ? (
                                                <div className="flex flex-col">
                                                    <span className="font-bold text-[#10B981]">{order.affiliateLink.user.name}</span>
                                        ...
                                        <td className="py-4 px-6 font-bold text-[#10B981] dark:text-white">
