            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6 bg-white dark:bg-gray-900 p-8 rounded-xl shadow-lg shadow-emerald-600/20 border border-gray-100 dark:border-gray-800">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={handleSave}
                        disabled={saving}
                        className="bg-emerald-700-600 hover:bg-emerald-700 text-white font-bold px-8 py-4 rounded-xl flex items-center justify-center gap-3 transition-all active:scale-95 shadow-lg shadow-emerald-600/20 shadow-accent-500/20 disabled:opacity-50"
                    >
