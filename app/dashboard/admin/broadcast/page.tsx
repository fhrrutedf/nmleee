    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-700">
            ...
            <div className="text-center md:text-right">
                ...
                <p className="text-slate-500 dark:text-slate-400 mt-2 max-w-2xl">أرسل رسائل مخصصة لشرائح معينة من مستخدمين "تمالين" بدقة عالية لزيادة التفاعل.</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                {/* Main Form */}
                <div className="lg:col-span-8 space-y-6">
                    <section className="bg-white dark:bg-emerald-700/50 border border-slate-200 dark:border-slate-800 rounded-xl p-8 shadow-lg shadow-emerald-600/20">
                    ...
                    {result && (
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <div className="p-3 bg-blue-100 dark:bg-emerald-700-500/20 text-emerald-600-600 dark:text-blue-400 rounded-xl">
                ...
                <div className="lg:col-span-4 space-y-6">
                    <section className="bg-emerald-700 border border-slate-800 rounded-xl p-6 shadow-lg shadow-emerald-600/20 overflow-hidden">
