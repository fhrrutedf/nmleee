                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <section className="bg-[#0A0A0A] dark:bg-emerald-700 text-white/50 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-lg shadow-[#10B981]/20 overflow-hidden relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                            ...
                            <div className={`p-4 rounded-xl border transition-all ${settings.cartReminder3Enabled ? 'border-emerald-600-500 bg-emerald-700 text-white-500/5' : 'border-emerald-500/20 dark:border-slate-800 opacity-60'}`}>
                                <div className="flex items-center justify-between mb-4">
                    ...
                    <section className="bg-emerald-700 text-white border border-slate-800 rounded-xl p-6 shadow-lg shadow-[#10B981]/20 h-full flex flex-col">
                        ...
                        <div className="space-y-4 flex-1 overflow-y-auto max-h-[600px] scrollbar-thin scrollbar-thumb-slate-700">
                            {carts.length === 0 ? (
                                ...
                                carts.map((cart: any) => (
                                    <div key={cart.id} className="bg-slate-800/50 border border-slate-700 p-3.5 rounded-xl hover:bg-emerald-700 text-white transition-colors group">
                                        ...
                                        <div className="flex items-center justify-between gap-2 border-t border-slate-700/50 pt-2.5 mt-2.5">
                                            <div className="flex items-center gap-1.5 bg-emerald-700 text-white px-2 py-0.5 rounded-lg border border-slate-700">
