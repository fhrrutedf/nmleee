    ...
    return (
        <div className="max-w-4xl mx-auto pb-12">
            ...
            <div className="flex items-center gap-2 text-sm text-text-muted mb-6">
                <button onClick={() => router.push(`/dashboard/courses/${courseId}/quizzes`)} className="hover:text-action-blue transition-colors">
                    الاختبارات
                </button>
                <FiArrowRight size={12} />
                <span className="text-primary-charcoal dark:text-white font-medium">تعديل: {formData.title}</span>
            </div>

            <div className="card">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-2xl font-bold text-primary-charcoal dark:text-white">تعديل الاختبار</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Quiz Builder */}
                    <div>
                        <h3 className="text-lg font-semibold text-primary-charcoal dark:text-white mb-4">الأسئلة</h3>
                        <QuizBuilder
