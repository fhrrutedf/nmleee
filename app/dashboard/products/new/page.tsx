                        ...
                        {currentStep === 3 && (
                            <motion.div key="st3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-10">
                                ...
                                <Section title="خيارات الطرح والنشر في المتجر" icon={<FiEye />}>
                                    <div className="flex items-center justify-between p-8 bg-emerald-600 rounded-xl border border-white/10 shadow-lg shadow-emerald-600/20 transition-all cursor-pointer hover:bg-emerald-700 group" onClick={() => update('isActive', !formData.isActive)}>
                                        <div className="text-right">
                        ...
                        <div className="w-full md:w-auto">
                            {currentStep < 3 ? (
                                <button
                                    ...
                                    className="w-full md:w-auto px-12 py-4 bg-emerald-600-600 text-white rounded-[1.5rem] font-bold flex items-center justify-center gap-2 hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-600/20 shadow-blue-100 active:scale-95 text-lg"
                                >
                                ...
                                <button
                                    ...
                                    className="w-full md:w-auto px-12 py-4 bg-emerald-600 text-white rounded-[1.5rem] font-bold flex items-center justify-center gap-3 hover:opacity-90 transition-all shadow-lg shadow-emerald-600/20 shadow-teal-200 disabled:opacity-50 active:scale-95 text-lg"
                                >
                ...
                <div className="sticky top-10 space-y-6">
                    ...
                    <div className="bg-white rounded-xl border border-slate-100 shadow-lg shadow-emerald-600/20 overflow-hidden transition-all hover:shadow-lg shadow-emerald-600/20 hover:-translate-y-1 block">
                        ...
                        <div className="p-6">
                            ...
                            <button className="w-full mt-6 py-4 bg-emerald-600-500 text-white font-bold rounded-xl text-sm transition-colors shadow-lg shadow-emerald-600/20 shadow-accent-500/30 flex items-center justify-center gap-2" disabled>
                    ...
                    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/50  ">
                        <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="bg-white rounded-xl p-12 max-w-sm w-full text-center space-y-10 shadow-lg shadow-emerald-600/20">
                             ...
                             <div className="flex flex-col gap-4">
                                <button onClick={handleSubmit} className="w-full py-5 bg-emerald-600-600 text-white rounded-xl font-bold shadow-lg shadow-emerald-600/20 hover:bg-emerald-600 transition-all text-lg">نعم، أطلق المنتج فوراً للعلن</button>
    ...
    return (
        <div className="bg-white rounded-xl p-8 lg:p-14 shadow-lg shadow-emerald-600/20 border border-slate-50 space-y-10 overflow-hidden relative">
            <div className="flex items-center gap-5">
                <div className="w-16 h-16 bg-emerald-600-50 text-emerald-600-600 rounded-xl flex items-center justify-center text-3xl shadow-lg shadow-emerald-600/20 shrink-0">
                    {icon}
                </div>
                <div className="text-right">
