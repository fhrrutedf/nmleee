                                    ...
                                    >
                                        <td className="p-6">
                                            <div className="flex items-center gap-4 min-w-[250px]">
                                                ...
                                                <div>
                                                    <h3 className={`text-sm font-bold line-clamp-1 ${product.title?.includes('Screenshot') ? 'text-red-500 italic' : 'text-white'}`}>
                                                    ...
                                                    <>
                                                        ...
                                                        <div className="absolute left-6 top-[80%] z-50 w-44 bg-[#0A0A0A] rounded-xl shadow-lg shadow-[#10B981]/20 border border-slate-50 p-2 animate-in fade-in slide-in-from-top-2 duration-200">
                                                            <Link 
                                                                ...
                                                                target="_blank"
                                                                className="flex items-center gap-3 w-full p-3 hover:bg-[#111111] rounded-xl text-gray-400 font-bold text-xs transition-colors"
                                                            >
