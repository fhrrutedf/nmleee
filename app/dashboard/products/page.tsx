...
export default function ProductsPage() {
    ...
    return (
        <div className="space-y-8 pb-32 text-right px-2 md:px-6" dir="rtl">
            ...
            {/* --- HEADER --- */}
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 bg-white dark:bg-card-white rounded-xl p-8 shadow-lg shadow-emerald-600/20 border border-slate-50 dark:border-gray-800">
                <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="md:col-span-2 relative">
                    ...
                    <input 
                        ...
                        className="w-full h-14 pr-12 pl-4 bg-white dark:bg-card-white border border-slate-100 dark:border-gray-800 rounded-[1.2rem] text-sm font-bold shadow-lg shadow-emerald-600/20 focus:ring-4 focus:ring-subtle/50 outline-none transition-all dark:text-white"
                        value={search}
                ...
                <div>
                    <select 
                        className="w-full h-14 bg-white dark:bg-card-white border border-slate-100 dark:border-gray-800 rounded-[1.2rem] px-4 text-xs font-bold text-slate-500 outline-none shadow-lg shadow-emerald-600/20 cursor-pointer"
            ...
            {/* --- PRODUCTS TABLE --- */}
            <div className="bg-white dark:bg-card-white rounded-xl shadow-lg shadow-emerald-600/20 border border-slate-50 dark:border-gray-800 overflow-hidden">
                                    ...
                                    >
                                        <td className="p-6">
                                            <div className="flex items-center gap-4 min-w-[250px]">
                                                <div className="w-14 h-14 rounded-xl overflow-hidden border border-slate-100 bg-slate-50 shrink-0 shadow-lg shadow-emerald-600/20">
                                        ...
                                        <td className="p-6 text-center">
                                            <span className="px-3 py-1 bg-white border border-slate-100 rounded-lg text-[10px] font-bold text-slate-500 shadow-lg shadow-emerald-600/20 lowercase">
                                        ...
                                        <td className="p-6 text-center relative">
                                            <div className="flex items-center justify-center gap-2">
                                                <Link 
                                                    ...
                                                    className="w-10 h-10 bg-white border border-slate-100 rounded-xl flex items-center justify-center text-slate-400 hover:text-primary-ink hover:bg-subtle transition-all shadow-lg shadow-emerald-600/20"
                                                    title="تعديل كامل"
                                                >
                                                    <FiEdit2 size={16} />
                                                </Link>
                                                ...
                                                {openMenuId === product.id && (
                                                    <>
                                                        ...
                                                        <div className="absolute left-6 top-[80%] z-50 w-44 bg-white rounded-xl shadow-lg shadow-emerald-600/20 border border-slate-50 p-2 animate-in fade-in slide-in-from-top-2 duration-200">
                                                            <Link 
