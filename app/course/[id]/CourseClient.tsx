            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-xl shadow-lg shadow-emerald-600/20 p-8 sticky top-6 border border-gray-100">
                           <div className="text-center mb-8">
                            ...
                            <div className="space-y-4 mb-8">
                                <button onClick={enrollNow} className="w-full btn btn-primary text-xl py-5 rounded-xl font-bold shadow-lg shadow-emerald-600/20 shadow-accent/20">سجّل الآن</button>
