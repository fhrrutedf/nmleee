...
export default function AboutPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0A0A0A] overflow-hidden selection:bg-emerald-700 text-white/20">
            ...
            <section className="relative bg-emerald-700 text-white py-32 md:py-48 flex items-center overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 text-center relative z-10 w-full">
                    <motion.div style={{ y: yHero, opacity: opacityHero }}>
                        ...
                        >
                            نحن نصنع <span className="text-[#10B981]">مستقبل</span> التعليم الرقمي
                        </motion.h1>
                        <motion.p
            ...
            {/* High-Contrast Stats */}
            <section className="py-32 bg-[#0A0A0A] relative z-20 -mt-10">
                            ...
                            <div className="space-y-6 mb-12">
                                {[
                                    ...
                                    <div key={i} className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-[#10B981] mb-1">{item.t}</h4>
            ...
            <section className="py-32 bg-[#111111]/50">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-5xl font-bold text-[#10B981] tracking-tight mb-4">الركائز <span className="text-[#10B981]">التقنية</span></h2>
