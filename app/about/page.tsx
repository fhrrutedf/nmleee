...
export default function AboutPage() {
    ...
    return (
        <div className="min-h-screen bg-white overflow-hidden selection:bg-emerald-700/20">
                ...
                <div className="max-w-7xl mx-auto px-6 text-center relative z-10 w-full">
                    <motion.div style={{ y: yHero, opacity: opacityHero }}>
                        <motion.div 
                            ...
                            className="inline-block px-4 py-1.5 bg-white/5 border border-white/10 rounded-xl text-[10px] font-bold uppercase tracking-[0.3em] mb-8 text-emerald-600"
                        >
                            Our Mission & Vision
                        </motion.div>
                        <motion.h1
                        ...
                        >
                            نحن نصنع <span className="text-emerald-600">مستقبل</span> التعليم الرقمي
                        </motion.h1>
                        <motion.p
                    ...
                    >
                        {[
                            ...
                            <motion.div key={idx} variants={fadeInUp} className="text-right p-8 bg-gray-50 border border-gray-100 rounded-xl hover:border-emerald-600/20 transition-all group">
                                <div className="w-12 h-12 bg-white border border-gray-100 rounded-xl flex items-center justify-center text-emerald-600 mb-6 group-hover:bg-emerald-700 group-hover:text-white transition-all shadow-lg shadow-emerald-600/20">
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        ...
                        >
                            ...
                            <div className="space-y-6 mb-12">
                                {[
                                    ...
                                    <div key={i} className="flex gap-4">
                                        <div className="w-6 h-6 rounded-xl bg-emerald-700/10 flex items-center justify-center text-emerald-600 shrink-0 mt-1">
                            ...
                            <Link href="/register" className="inline-flex py-4 px-10 bg-emerald-700 text-white rounded-xl font-bold hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-600/20 shadow-ink/10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="bg-white border border-gray-100 p-10 rounded-xl hover:border-emerald-600/20 transition-all group shadow-lg shadow-emerald-600/20">
                                <div className="w-14 h-14 bg-gray-50 text-emerald-600 rounded-xl flex items-center justify-center mb-8 group-hover:bg-emerald-700 group-hover:text-white transition-all shadow-lg shadow-emerald-600/20">
            ...
            <section className="py-24 bg-emerald-700 relative overflow-hidden">
                <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/register" className="px-12 py-5 bg-emerald-700 text-white rounded-xl font-bold hover:bg-emerald-700-hover transition-all shadow-lg shadow-emerald-600/20 shadow-accent/20">
                            أنشئ متجرك مجاناً
                        </Link>
