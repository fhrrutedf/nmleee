            ...
            <div className="max-w-7xl mx-auto px-4 py-20 lg:py-32 relative z-10">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-8xl font-bold text-[#10B981] mb-10 tracking-tighter leading-[1.05]">
                        تحدث معنا <br/> <span className="text-[#10B981] underline underline-offset-[12px] decoration-accent/10">مباشرة</span>
                    </h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8 xl:gap-12">
                    ...
                    >
                        {[
                            ...
                            {
                                icon: <FiPhone className="text-2xl text-[#10B981]" />,
                                title: 'الدعم التقني',
                            ...
                            {
                                icon: <FiMapPin className="text-2xl text-[#10B981]" />,
                                title: 'المقر الرقمي',
                            ...
                            >
                                ...
                                <div>
                                    <h3 className="font-bold text-xl mb-3 text-[#10B981]">{info.title}</h3>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="relative group">
                                        <input
                                            ...
                                            required
                                        />
                                        <label htmlFor="name" className="absolute text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-transparent px-2 peer-focus:px-2 peer-focus:text-[#10B981] peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 right-4">
                                    ...
                                    <div className="relative group">
                                        <input
                                            ...
                                            required
                                        />
                                        <label htmlFor="email" className="absolute text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-transparent px-2 peer-focus:px-2 peer-focus:text-[#10B981] peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 right-4">
                                ...
                                <div className="relative group">
                                    <input
                                        ...
                                        required
                                    />
                                    <label htmlFor="subject" className="absolute text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-transparent px-2 peer-focus:px-2 peer-focus:text-[#10B981] peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 right-4">
                                ...
                                <div className="relative group">
                                    <textarea
                                        ...
                                        required
                                    />
                                    <label htmlFor="message" className="absolute text-gray-500 duration-300 transform -translate-y-4 scale-75 top-6 z-10 origin-[0] bg-transparent px-2 peer-focus:px-2 peer-focus:text-[#10B981] peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-8 peer-focus:top-6 peer-focus:scale-75 peer-focus:-translate-y-4 right-4">
