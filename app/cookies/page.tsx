...
export default function CookiesPage() {
  return (
    <div className="min-h-screen bg-subtle py-20 px-6">
      <div className="max-w-3xl mx-auto bg-white p-10 rounded-2xl border border-gray-100 shadow-lg shadow-emerald-600/20" dir="rtl">
        <h1 className="text-3xl font-bold text-emerald-600 mb-8">سياسة الكوكيز (Cookies Policy)</h1>
